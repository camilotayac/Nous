...
subtitle: "Capítulo 14 — Theodore L. Brown, *Química, la ciencia central* (12ª ed., 2014)"
bibliography: ../references.bib
---

# Cinética química {#sec-cinetica}
...
Para que ocurra una reacción química debe ocurrir colisiones o choques entre los reactivos para que haya una transferencia de átomos o una reorganización de enlaces formando el producto. Esto solo ocurre si el choque o colisión se da en la posición correcta y si tiene la suficiente energía [@brown2014].

## Factores que influyen en la velocidad de reacción

Cuatro factores permiten modificar la velocidad con que ocurre una reacción en particular (@tbl-factores).

| # | Factor | Efecto sobre la velocidad |
|---|--------|---------------------------|
| 1 | Estado físico de los reactivos | Mezcla homogénea → más colisiones; heterogénea → menos |
| 2 | Concentración de los reactivos | Mayor concentración → mayor frecuencia de colisiones |
| 3 | Temperatura | Mayor T → mayor frecuencia **y energía** de colisiones |
| 4 | Catalizadores | Alteran mecanismos → cambian tipo de colisiones |

: Los cuatro factores que influyen en la velocidad de reacción {#tbl-factores}
...
El cuarto factor es la utilización de catalizador. Un catalizador es un compuesto que permite acelerar una reacción química afectando los tipos de colisiones y modificando los mecanismos de reacción, sin participar en la reacción química. Es decir no entra como un reactivo, la cantidad de catalizador al comienzo de la reacción es la misma al finalizar la reacción química.
